      ...
      >
        ...
        <Box>
          <FooterSection title="status" delay={0.2}>
            ...
            >
              Currently working as a freelance designer and developer, focusing on creating engaging web experiences.
            </Typography>
          </FooterSection>
        ...
        <Box>
          ...
          <FooterSection title="credits" delay={0.5}>
            ...
            >
              This website is built with love using React, Material-UI, and Framer Motion. Special thanks to the open-source community for their contributions.
